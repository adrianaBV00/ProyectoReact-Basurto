...
Si desea ver el proyecto online, puede ingresar al siguiente link: [Coder App](https://kamiCollectionsReact.vercel.app/)


### Librerias utilizadas en el proyecto 📖

- [React Bootstrap](https://react-bootstrap.netlify.app): utilizada para el styling de la app.
- [React Icons](https://react-bootstrap.netlify.app): utilizada para iconos.
...
- [Material-UI](https://mui.com/material-ui): utilizada para poner el rating.
- [Formik](https://formik.org/): utilizada para implementar la validacion del formulario
- [YUP](https://www.npmjs.com/package/yup): utilizada para implementar la validacion del formulario



Desarrollado por AdrianaBV